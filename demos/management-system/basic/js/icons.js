/* ============================================================
   FreshWash — Icon Library
   Semua ikon SVG sebagai fungsi -> h('svg', ...)
   ============================================================ */
...
const I = {
  /* Brand */
  bubble: () => S('<path d="M7.5 6.5a2.5 2.5 0 0 1 0-5 2.5 2.5 0 0 1 0 5Z"/><path d="M16.5 8.5a2 2 0 0 1 0-4 2 2 0 0 1 0 4Z"/><path d="M17 14a3 3 0 0 1 0-6 3 3 0 0 1 0 6Z"/><path d="M7 13a4 4 0 0 1 0-8 4 4 0 0 1 0 8Z"/><path d="M4 22h16a2 2 0 0 0 2-2v-8a2 2 0 0 0-2-2h-2"/>'),
  ...
  /* Catalog */
  tag: () => S('<path d="M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z"/><circle cx="7.5" cy="7.5" r=".5"/>'),
  ...
  price: () => S('<path d="M12 2v20"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/>'),
  ...
  washer: () => S('<rect width="18" height="20" x="3" y="2" rx="2"/><circle cx="12" cy="13" r="5"/><path d="M6 6h.01"/><path d="M9 6h.01"/><circle cx="12" cy="13" r="2"/>'),
  wind: () => S('<path d="M17.7 7.7a2.5 2.5 0 1 1 1.8 4.3H2"/><path d="M9.6 4.6A2 2 0 1 1 11 8H2"/><path d="M12.6 19.4A2 2 0 1 0 14 16H2"/>'),
...
/* Helper: get icon by name, fallback home */
function icon(name) {
  const fn = I[name];
  return fn ? fn() : I.home();
}